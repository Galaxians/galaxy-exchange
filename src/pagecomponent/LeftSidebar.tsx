    ...
    return (
        <SidebarContainer isOpen={isOpen}>
            <div style={{ color: 'rgb(201, 187, 206)', height: '150px', border: '1px solid #FF00FF', borderRadius: '5px ', padding: '15px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div style={{ color: '#FF00FF', fontSize: '22px', fontWeight: 900 }}>GLX Stats</div>
            ...
            <div style={{ height: '120px', border: '1px solid #FF00FF', borderRadius: '5px ', padding: '15px', marginTop: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div style={{ color: '#FF00FF', fontSize: '22px', fontWeight: 800 }}>Total Value Locked</div>
                <div style={{ color: 'white', fontSize: '29px', fontWeight: 600}}>2648710.50</div>
            ...
            <div style={{ marginTop: '350px', height: '120px', padding: '15px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                <div style={{ color: 'rgb(201, 187, 206)', display: 'flex', alignItems: 'center' }}><img src="./assets/img/bscscan-icon.svg" alt="bscscan" style={{ width: "24px" }} /><div style={{ fontSize: '12px' }}>GALAXIA Holders</div></div>
            </div>
